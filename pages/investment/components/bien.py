...
class Bien(BaseSection):
    ...
    def render(self):
        with st.expander("Caractéristiques du Bien Immobilier", expanded=False): 
            ...
            travaux_prevus = st.number_input("Montant des travaux prévus (€)", min_value=0, step=1000, key="travaux_prevus")
